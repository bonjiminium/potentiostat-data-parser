...
<a
href="https://github.com/bxw315-umd/potentiostat-data-parser/blob/main/potentiostat_data_parser/palmsens.py#L46"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/bxw315-umd/potentiostat-data-parser/blob/main/potentiostat_data_parser/palmsens.py#L58"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
with open(os.path.join("../test_files/CVs_palmsens", "teas.csv"), encoding="utf-16") as f:
    contents = f.read()
